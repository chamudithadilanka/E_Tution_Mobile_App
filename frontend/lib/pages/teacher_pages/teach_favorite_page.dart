...
import 'package:frontend/pages/teacher_pages/qrcode/fetchAttendanceStudentQr.dart';
...
class TeacherFavoritePage extends StatefulWidget {
  ...
  @override
  State<TeacherFavoritePage> createState() =>
      _TeacherFavoritePageState();
}
                                            ...
                                            child: ElevatedButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder:
                                                        (context) => FetchQrCodeStudentAttendance(classId:classModel.id ,)
                                                  ),
                                                );
                                              },
                                              child: Text(
