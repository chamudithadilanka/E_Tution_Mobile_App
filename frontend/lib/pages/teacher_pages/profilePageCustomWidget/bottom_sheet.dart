...
class BottomSheetProfileUpateTeacher extends StatefulWidget {
  final String Image;
  ...
  const BottomSheetProfileUpateTeacher({
    super.key,
    required this.Image,
  ...
  @override
  State<BottomSheetProfileUpateTeacher> createState() =>
      _BottomSheetProfileUpateTeacherState();
}

class _BottomSheetProfileUpateTeacherState
    extends State<BottomSheetProfileUpateTeacher> {
  ...
  void initState() {
    ...
    subjectsController.text = widget.subjects;
    gradeController.text = widget.gradesTaught;
    qualificationController.text = widget.qualifications;
  ...
  Future<void> updateProfile() async {
    try {
      if (_formKey.currentState!.validate()) {
        final result = await apiService.updateTeacherDetails(
          userId: userId,
          ...
          gradesTaught: gradeController.text,
              ...
              child: CircleAvatar(
                ...
                backgroundImage:
                    profileImage != null
                        ...
                        : NetworkImage(
                          "${ApiService.ip}uploads/${widget.Image}",
                        ),
              ),
            ),
            SizedBox(height: 15),
